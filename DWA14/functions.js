...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const elements = {
    number: this.shadowRoot.querySelector('input[data-key="number"]'),
    add: this.shadowRoot.querySelector('button[data-key="add"]'),
    subtract: this.shadowRoot.querySelector('[data-key="subtract"]'),
    reset: this.shadowRoot.querySelector('[data-key="reset"]'),
  };
